...
TEST(Set_Test, RangeOfAnotherType) {
    ...
    sgcl::set<FromInt> from_ints(ints.begin(), ints.end());
    ...
    EXPECT_EQ(from_ints.size(), 5u);
    FromInt::conversions = 0;
    sgcl::multiset<FromInt> multi(ints.begin(), ints.end());
    EXPECT_EQ(FromInt::conversions, ints.size());
