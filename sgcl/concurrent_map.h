...
namespace sgcl {
    ...
    public:
        ...
        pair<iterator, bool> try_emplace(const Key& key, A&&... a) {
            ...
            return this->_insert(this->_make_node(h, std::piecewise_construct, forward_as_tuple(key), forward_as_tuple(std::forward<A>(a)...)), h);
        }
        ...
        pair<iterator, bool> try_emplace(Key&& key, A&&... a) {
            ...
            unsigned h = this->_height();
            return this->_insert(this->_make_node(h, std::piecewise_construct, forward_as_tuple(std::move(key)), forward_as_tuple(std::forward<A>(a)...)), h);
        }
