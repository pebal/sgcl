...
namespace sgcl {
    ...
    , public m_enumerable<sorted_multiset<Key, Compare>>
    , public m_bidirectional<sorted_multiset<Key, Compare>>
    , public m_equatable<sorted_multiset<Key, Compare>>
    , public m_comparable<sorted_multiset<Key, Compare>> {
