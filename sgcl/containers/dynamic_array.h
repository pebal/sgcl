...
namespace sgcl {
    ...
    template<class T>
    class dynamic_array
    : public m_enumerable<dynamic_array<T>>
    , public m_contiguous<dynamic_array<T>>
    , public m_random_access<dynamic_array<T>>
    , public m_bidirectional<dynamic_array<T>>
    , public m_equatable<dynamic_array<T>>
    , public m_comparable<dynamic_array<T>>
    , public m_ordered<dynamic_array<T>>
    , public m_sequence<dynamic_array<T>> {
    public:
        using value_type = T;
        using reference = T&;
