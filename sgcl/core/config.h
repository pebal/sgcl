...
#endif
    [[maybe_unused]] static constexpr unsigned WorkerSpinMicroseconds = SGCL_WORKER_SPIN_US;
...
#endif
    [[maybe_unused]] static constexpr unsigned BlockingThreads = SGCL_BLOCKING_THREADS;
