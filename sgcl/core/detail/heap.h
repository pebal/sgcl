...
namespace sgcl::detail {
    ...
    public:
        ...
        // its fence (types.h: BarrierRegion), since a thread preempted here
        // across the flip stamped the old epoch after the next cycle's
        // dirty pass, and the cycle after that took the page for clean
        SGCL_NOINLINE static void _stamp_slow(std::atomic<uint8_t>& card) noexcept {
