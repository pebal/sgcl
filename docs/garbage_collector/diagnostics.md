...
- `last_helpers_used` says whether the pool joined: the helpers start from `config::MarkObjectThreshold` objects and `SweepPageThreshold` pages ([config](../sgcl/core/config.md)).
