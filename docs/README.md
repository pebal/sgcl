...
The reference lies in one directory per module, the layout of the headers (`sgcl/{core,immutable,txt,math,concurrent,async,io,time,hash}/`), the page of a class next to the pages of its module, a `README.md` in every module directory that describes the module and lists its classes ([sgcl/core](sgcl/core/README.md), [immutable](sgcl/immutable/README.md), [concurrent](sgcl/concurrent/README.md), [async](sgcl/async/README.md), [io](sgcl/io/README.md)), and the index of the whole in [sgcl/README.md](sgcl/README.md).
