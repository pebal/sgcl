...
| [mixin::immutable](mixin/immutable.md) | `mixin/immutable.h` | a declaration without methods: a value that never changes, every change a new container; `im::vector`, `im::list`, `im::map`, `im::set` |
