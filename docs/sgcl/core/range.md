...
- [sorted_multimap](sorted_multimap.md), [multimap](multimap.md), [weak_map](weak_map.md): `equal_range`, the pair a `range` is made from
- [vector](vector.md), [the mixins](mixin/README.md): the containers and the algorithms a counted loop indexes into
