...
The same class in the `Sgcl` interface: [SpscQueue](../Sgcl/Concurrent/SpscQueue.md).
...
- [Benchmarks](benchmarks.md#the-single-producer-queue-the-cache-and-the-persistent-map): the ring on the channel's harness, an object allocated per item
