...
```cpp
#include "sgcl/concurrent/concurrent_set.h"   // or "sgcl/sgcl.h"
...
- [concurrent_unordered_set](concurrent_unordered_set.md), the hash set; [set](../containers/set.md), the sequential set
