...
```cpp
#include "sgcl/concurrent/concurrent_unordered_set.h"   // or "sgcl/sgcl.h"
...
- [concurrent_set](concurrent_set.md), the ordered set (a skip list); [unordered_set](../containers/unordered_set.md), the sequential set
