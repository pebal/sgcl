...
| unordered_map, 1 | 88 / 67 / 72 | 39 / 39 / 40 | 46 / 52 / 50 | 151 / 80 / 84 | 121 / 99 / 108 |
| unordered_map, 4 | 30 / 24 / 24 | 125 / 144 / 204 | 254 / 157 / 437 | 75 / 21 / 29 | 177 / 38 / 60 |
| unordered_map, 16 | 20 / 4.9 / 15 | 100 / 62 / 144 | 324 / 94 / 1095 | 61 / 8.2 / 8.1 | 346 / 54 / 56 |
| unordered_map, 32 | 19 / 5.7 / 11 | 107 / 67 / 171 | 342 / 120 / 1174 | 55 / 5.8 / 8.8 | 442 / 39 / 68 |
| unordered_map, 64 | 17 / 5.0 / 9.8 | 117 / 71 / 185 | 377 / 118 / 1850 | 65 / 5.4 / 8.0 | 421 / 17 / 77 |
...
## The single-producer queue, the cache and the persistent map

The three structures without a counterpart in Go's or Java's library, measured on 18 September 2026 with the same script (`CASES="spsc cache pmap"`) against what C++ has for each.
...
| threads | `concurrent_cache` | `unordered_map` + `list`, mutex |
|---|---|---|
| 1 | 73 | 39 |
| 4 | 26 | 163 |
| 16 | 22 | 137 |
...
The persistent map, one thread, 200,000 random `long` keys: an insertion a version each (the old one let go of), a lookup of a key present, the map built from a range at once, and `std::map` doing the same in place, ns per operation:

| | `persistent_map` | `std::map` |
|---|---|---|
| insert | 702 | 135 |
| find | 24 | 78 |
| built from a range, per element | 90 | |
